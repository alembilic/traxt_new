...
@section('titles')
    <title>Privacy statement for Traxr.net - Read about how we keep your information safe</title>
    <meta name="description" content="We value privacy and keeps your data safe at all costs. Read our privacy statement">
    ...
    <link rel="canonical" href="https://traxr.net/privacy" />
@endsection
@section('content')
    <section class="">
        <div class="container">
            <div class="row align-items-center pad-top-3 pad-bot-1 padding-sm-mob padding-lg-mob-top">
                ...
                <div class="col-md-12">
                    <div class="text-content">
                        ...
                        <h1 class="pt-2 align-center">Cookie & Privacy Policy for Traxr</h1>
                        <p class="pt-2 align-center text-md-light text-cen-wid-70">
                            <span class="fw-700">This is the Cookie & Privacy Policy for Traxr.net, accessible from https://traxr.net</span></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center pad-top-3 pad-bot-1 padding-lg-mob">
                <div class="col-md-12">
                    ...
                    <ul>
                        ...
                        <li>Orders processing related cookiesThis site offers e-commerce or payment facilities and some cookies are essential to ensure that your order is remembered between pages so that we can process it properly.</li>
                    ...
                    <br />
                    Hopefully that has clarified things for you and as was previously mentioned if there is something that you aren't sure whether you need or not it's usually safer to leave cookies enabled in case it does interact with one of the features you use on our site. This Cookies Policy was created with the help of the <a href="https://www.cookiepolicygenerator.com">Cookies Policy Template Generator</a> and the <a href="https://www.webterms.org">WebTerms Generator</a>.<br />
                    <br />
