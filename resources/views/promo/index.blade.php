...
@section('content')
    ...
    <section class="">
        <div class="container">
            <div class="row  pad-top-6 pad-bot-6 padding-sm-mob">
                ...
                <a class="btn-custom bc-btn-primary" style="margin-left:18px;" href="/features">View all features</a>
            </div>
        </div>
    </section>
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center pad-top-6 pad-bot-6 reverse-col-mob">
